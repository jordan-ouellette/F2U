...
<div class="container">
    ...
    <div class="jumbotron" style="background-image: url(/img/th.jpg);background-size: 100% 100%; min-height: 275px;">
    </div>
...
$_SESSION['currentdb'] = "timhortons";


##Create a query to Select all items from the timhortons table        
$query = "SELECT * from timhortons";
