...
<div class="container">
    ...
    <div class="jumbotron" style="background-image: url(/img/pp.jpg);background-size: 100% 100%; min-height: 275px;">
    </div>
...
<form action="removeitem.php" method="POST">
	...
	<select class="form-control" name="search">
		...
		echo $value."; {$row['Price']}; {$row['Calories']} Calories; {$row['Cprice']} Combo Price";
		?> 
		</option>
		<!-- End the option -->
		<?php 
