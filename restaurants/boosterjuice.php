...
<div class="container">
    ...
    <div class="jumbotron" style="background-image: url(../img/bj.jpg);background-size: 100% 100%; min-height: 275px;">
    </div>
...
$_SESSION['currentdb'] = "boosterjuice";


##Create a query to Select all items from the boosterjuice table        
$query = "SELECT * from boosterjuice";
...
<form action="../removeitem.php" method="POST">
	...
	<select class="form-control" name="search">
		...
		echo $value."; {$row['Price']}; {$row['Calories']} Calories";
		?> 
		</option>
		<!-- End the option -->
		<?php 
