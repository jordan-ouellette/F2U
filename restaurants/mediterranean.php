...
<div class="container">
    ...
    <div class="jumbotron" style="background-image: url(/img/me.jpg);background-size: 100% 100%; min-height: 275px;">
    </div>
...
$_SESSION['currentdb'] = "mediterranean";


##Create a query to Select all items from the mediterranean table        
$query = "SELECT * from mediterranean";
